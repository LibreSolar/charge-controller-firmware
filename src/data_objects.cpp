...
const data_object_t data_objects[] = {
    ...
    {0x70, TS_OUTPUT, TS_READ_ALL, TS_T_FLOAT32, 2, (void*) &(bat_terminal.bus->voltage),               "Bat_V"},
    {0x71, TS_OUTPUT, TS_READ_ALL, TS_T_FLOAT32, 2, (void*) &(solar_terminal.bus->voltage),             "Solar_V"},
    ...
    {0x7B, TS_OUTPUT, TS_READ_ALL, TS_T_FLOAT32, 2, (void*) &(bat_terminal.bus->chg_voltage_target),    "BatTarget_V"},
