...
const data_object_t data_objects[] = {
    ...
    {0x18, TS_INFO, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_UINT32, 0, (void*) &(deviceID),                       "DeviceID"},       // ToDo: TS_ACCESS_WRITE_AUTH only
    {0x19, TS_INFO, TS_ACCESS_READ,                   TS_T_STRING, 0, (void*) manufacturer,                      "Manufacturer"},
    {0x1A, TS_INFO, TS_ACCESS_READ,                   TS_T_STRING, 0, (void*) deviceName,                        "DeviceName"},
    //{0x1B, TS_INFO, TS_ACCESS_READ,                   TS_T_STRING, 0, (void*) &(?),                     "FirmwareVersion"},    // ToDo
    ...
    {0x01, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_UINT32,  0, (void*) &(timestamp),                                "Timestamp_s"},

    // battery settings
    {0x30, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.nominal_capacity),           "BatNom_Ah"},
    {0x31, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_recharge),           "BatRecharge_V"},
    {0x32, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_absolute_min),       "BatAbsMin_V"},
    {0x33, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.charge_current_max),         "BatChgMax_A"},
    {0x34, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_topping),            "BatTarget_V"},
    {0x35, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.current_cutoff_topping),     "BatCutoff_A"},
    {0x36, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_INT32,   0, (void*) &(bat_conf_user.time_limit_topping),         "BatCutoff_s"},
    {0x37, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,    0, (void*) &(bat_conf_user.trickle_enabled),            "TrickleEn"},
    {0x38, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_trickle),            "Trickle_V"},
    {0x39, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_INT32,   0, (void*) &(bat_conf_user.time_trickle_recharge),      "TrickleRecharge_s"},
    ...
    {0x53, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.charge_temp_min),            "BatChgMin_degC"},
    {0x54, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.discharge_temp_max),         "BatDisMax_degC"},
    {0x55, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 1, (void*) &(bat_conf_user.discharge_temp_min),         "BatDisMin_degC"},

    // load settings
    {0x40, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,    0, (void*) &(load.enabled_target),                      "LoadEnDefault"},
    {0x41, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,    0, (void*) &(load.usb_enabled_target),                  "USBEnDefault"},
    {0x42, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_load_disconnect),    "LoadDisconnect_V"},
    {0x43, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_load_reconnect),     "LoadReconnect_V"},
    //{0x44, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_load_disconnect),    "USBDisconnect_V"},
    //{0x45, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_FLOAT32, 2, (void*) &(bat_conf_user.voltage_load_reconnect),     "USBReconnect_V"},


    // other configuration items
    //{0x33, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,    2, (void*) &(??),   "WarningIndicator"},  // can be set externally
    //{0x33, TS_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,    2, (void*) &(??),   "ErrorIndicator"},

    // INPUT DATA /////////////////////////////////////////////////////////////
    // using IDs >= 0x60

    {0x60, TS_INPUT, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,   0, (void*) &(load.enabled_target),               "LoadEn"},   // change w/o store setting in NVM
    {0x61, TS_INPUT, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,   0, (void*) &(load.usb_enabled_target),           "USBEn"},
#ifdef CHARGER_TYPE_PWM
    {0x62, TS_INPUT, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL,   0, (void*) &(pwm_switch.enabled),                "PWMEn"},
#else
    ...
    // min/max recordings
    {0xB1, TS_REC, TS_ACCESS_READ, TS_T_UINT16,  2, (void*) &(log_data.solar_power_max_total),       "SolarMaxTotal_W"},
    {0xB2, TS_REC, TS_ACCESS_READ, TS_T_UINT16,  2, (void*) &(log_data.load_power_max_total),        "LoadMaxTotal_W"},
    {0xB3, TS_REC, TS_ACCESS_READ, TS_T_FLOAT32, 2, (void*) &(log_data.battery_voltage_max),         "BatMaxTotal_V"},
    ...
    {0xD0, TS_CAL, TS_ACCESS_READ | TS_ACCESS_WRITE_AUTH, TS_T_FLOAT32, 1, (void*) &(dcdc.ls_current_min),   "DcdcMin_A"},
    {0xD1, TS_CAL, TS_ACCESS_READ | TS_ACCESS_WRITE_AUTH, TS_T_FLOAT32, 1, (void*) &(dcdc.hs_voltage_max),   "SolarAbsMax_V"},
    {0xD2, TS_CAL, TS_ACCESS_READ | TS_ACCESS_WRITE_AUTH, TS_T_INT32,   0, (void*) &(dcdc.restart_interval), "DcdcRestart_s"},
    //{0xD3, TS_CAL, TS_ACCESS_READ | TS_ACCESS_WRITE_AUTH, TS_T_FLOAT32, 1, (void*) &(dcdc.offset_voltage_start), "SolarOffsetStart_V"},
