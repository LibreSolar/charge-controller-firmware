...
{
#ifdef DT_OUTPUTS_V_SOLAR_PRESENT
    struct device *dev = device_get_binding(DT_OUTPUTS_V_SOLAR_GPIOS_CONTROLLER);
    gpio_pin_configure(dev, DT_OUTPUTS_V_SOLAR_GPIOS_PIN,
        DT_OUTPUTS_V_SOLAR_GPIOS_FLAGS | GPIO_OUTPUT_ACTIVE);
#endif
