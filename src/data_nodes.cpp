...
=======
    ...
    TS_NODE_STRING(0x1E, "FirmwareCommit", firmware_commit, 0,
        ID_INFO, TS_ANY_R, 0),
>>>>>>> 797558e (Added a parser to scrap additional information for the esp-edge and added json-snippets for ts-nodes)
    ...
    TS_NODE_UINT32(0x21, "FlashSize_KiB", &flash_size,
    ...
    TS_NODE_UINT32(0x22, "FlashPageSize_KiB", &page_size,
        ID_INFO, TS_ANY_R | TS_ANY_W, PUB_SER | PUB_NVM),
