...
static bool init_has_run(u64_t *guard_object)
{
	return (((u8_t *)guard_object)[0] != 0);
}

static void set_init_has_run(u64_t *guard_object)
{
	((u8_t *)guard_object)[0] = 1;
}
 ...
 */
int __cxa_guard_acquire(u64_t *guard_object)
{
	int res;
 ...
 */
void __cxa_guard_release(u64_t *guard_object)
{
 ...
 * exception.
 */
void __cxa_guard_abort(u64_t *guard_object)
{
	k_mutex_unlock(&guard_mutex);
}
