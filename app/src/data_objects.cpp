...
THINGSET_ADD_ITEM_STRING(ID_DEVICE, 0x420, "cManufacturer", manufacturer, 0,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_STRING(ID_DEVICE, 0x421, "cType", device_type, 0,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_STRING(ID_DEVICE, 0x422, "cHardwareVersion", hardware_version, 0,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_STRING(ID_DEVICE, 0x423, "cFirmwareVersion", firmware_version, 0,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_UINT32(ID_DEVICE, 0x430, "rUptime_s", &timestamp,
...
THINGSET_ADD_ITEM_UINT32(ID_DEVICE, 0x431, "rErrorFlags", &dev_stat.error_flags,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_UINT16(ID_DEVICE, 0x4BE, "sCANAddress", &can_node_addr,
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x531, "rVoltage_V", &bat_bus.voltage, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x532, "rCurrent_A", &bat_terminal.current, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x533, "rPower_W", &bat_terminal.power, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x56B, "pDisCapacity_Ah", &charger.discharged_Ah, 0,   // coulomb counter
    THINGSET_ANY_R | THINGSET_MFR_W, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x5A0, "sNominalCapacity_Ah", &bat_conf_user.nominal_capacity, 1,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_BATTERY, 0x5B1, "sIntResistance_Ohm", &bat_conf_user.internal_resistance, 3,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_UINT32(ID_CHARGER, 0x650, "rState", &charger.state,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x651, "rControlTargetVoltage_V", &bat_bus.sink_voltage_intercept, 2,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x652, "rControlTargetCurrent_A", &bat_terminal.pos_current_limit, 2,
    THINGSET_ANY_R, 0);
...
THINGSET_ADD_ITEM_UINT16(ID_CHARGER, 0x654, "rDCDCState", &dcdc.state,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6A1, "sChgCurrentLimit_A", &bat_conf_user.charge_current_max, 1,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6A3, "sChgCutoffCurrent_A", &bat_conf_user.topping_cutoff_current, 1,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6A9, "sEqlChgVoltage_V", &bat_conf_user.equalization_voltage, 2,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6AA, "sEqlChgCurrent_A", &bat_conf_user.equalization_current_limit, 2,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_UINT32(ID_CHARGER, 0x6AC, "sEqlMaxInterval_d", &bat_conf_user.equalization_trigger_days,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_UINT32(ID_CHARGER, 0x6AD, "sEqlDeepDisTrigger", &bat_conf_user.equalization_trigger_deep_cycles,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6AF, "sAbsMinVoltage_V", &bat_conf_user.absolute_min_voltage, 2,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_CHARGER, 0x6B0, "sTempCompensation_mV_K", &bat_conf_user.temperature_compensation, 3,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_SOLAR, 0x738, "rVoltage_V", &pwm_switch.ext_voltage, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
#else
THINGSET_ADD_ITEM_FLOAT(ID_SOLAR, 0x738, "rVoltage_V", &solar_bus.voltage, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
#endif
...
THINGSET_ADD_ITEM_FLOAT(ID_SOLAR, 0x739, "rCurrent_A", &solar_terminal.current, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0x83B, "rCurrent_A", &load.current, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0x83C, "rPower_W", &load.power, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_INT32(ID_LOAD, 0x855, "rState", &load.info,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_BOOL(ID_LOAD, 0x880, "wEnable", &load.enable,
    THINGSET_ANY_R | THINGSET_ANY_W, 0);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0xB8, "sDisconnectVoltage_V", &bat_conf_user.load_disconnect_voltage, 2,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0x8B9, "sReconnectVoltage_V", &bat_conf_user.load_reconnect_voltage, 2,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0x8B5, "sDisMaxTemperature_degC", &bat_conf_user.discharge_temp_max, 1,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_FLOAT(ID_LOAD, 0x8B6, "sDisMinTemperature_degC", &bat_conf_user.discharge_temp_min, 1,
    THINGSET_ANY_R | THINGSET_ANY_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_INT32(ID_USB, 0x956, "rState", &usb_pwr.info,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_BOOL(ID_USB, 0x981, "wEnable", &usb_pwr.enable,
    THINGSET_ANY_R | THINGSET_ANY_W, 0);
...
THINGSET_ADD_ITEM_FLOAT(ID_NANOGRID, 0xA3D, "rVoltage_V", &hv_bus.voltage, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_NANOGRID, 0xA3E, "rCurrent_A", &hv_terminal.current, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_FLOAT(ID_NANOGRID, 0xA3F, "rPower_W", &hv_terminal.power, 2,
    THINGSET_ANY_R, TS_SUBSET_LIVE);
...
THINGSET_ADD_ITEM_UINT32(ID_NANOGRID, 0xA67, "pImportTotalEnergy_Wh", &dev_stat.grid_import_total_Wh,
    THINGSET_ANY_R | THINGSET_MFR_W, TS_SUBSET_NVM);
...
THINGSET_ADD_ITEM_UINT32(ID_NANOGRID, 0xA68, "pExportTotalEnergy_Wh", &dev_stat.grid_export_total_Wh,
    THINGSET_ANY_R | THINGSET_MFR_W, TS_SUBSET_NVM);
...
#if BOARD_HAS_LOAD_OUTPUT
        load.set_voltage_limits(bat_conf.load_disconnect_voltage,
