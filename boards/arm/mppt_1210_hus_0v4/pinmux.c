...
const char *led_ports[CONFIG_NUM_LED_PINS] = {
    DT_GPIO_LEDS_GND_GPIOS_CONTROLLER,
    DT_GPIO_LEDS_SOC12_GPIOS_CONTROLLER,
    DT_GPIO_LEDS_SOC3_GPIOS_CONTROLLER,
    DT_GPIO_LEDS_RXTX_GPIOS_CONTROLLER,
    DT_GPIO_LEDS_LOAD_GPIOS_CONTROLLER
};
const int led_pins[CONFIG_NUM_LED_PINS] = {
    DT_GPIO_LEDS_GND_GPIOS_PIN,
    DT_GPIO_LEDS_SOC12_GPIOS_PIN,
    DT_GPIO_LEDS_SOC3_GPIOS_PIN,
    DT_GPIO_LEDS_RXTX_GPIOS_PIN,
    DT_GPIO_LEDS_LOAD_GPIOS_PIN
};
